...
CREATE TABLE `emp_transfer` (
  ...
  `current_brn_name` varchar(255) DEFAULT NULL,
  `designation` varchar(255) DEFAULT NULL,
  `employee_id` varchar(255) DEFAULT NULL,
  `transfered_brn_name` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `emp_transfer`
--

LOCK TABLES `emp_transfer` WRITE;
/*!40000 ALTER TABLE `emp_transfer` DISABLE KEYS */;
/*!40000 ALTER TABLE `emp_transfer` ENABLE KEYS */;
UNLOCK TABLES;
