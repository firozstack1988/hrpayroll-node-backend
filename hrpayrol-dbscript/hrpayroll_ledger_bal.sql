...
--
-- Table structure for table `ledger_bal`
--

DROP TABLE IF EXISTS `ledger_bal`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ledger_bal` (
...
--
-- Dumping data for table `ledger_bal`
--

LOCK TABLES `ledger_bal` WRITE;
/*!40000 ALTER TABLE `ledger_bal` DISABLE KEYS */;
/*!40000 ALTER TABLE `ledger_bal` ENABLE KEYS */;
UNLOCK TABLES;
